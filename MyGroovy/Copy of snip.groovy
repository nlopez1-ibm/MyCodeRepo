// area to explore the lang better -  lePez
// run as groovy snip.groovy
// http://groovy-lang.org/documentation.html
//------------------------------------
println "My Cool and Groovy Snippets"
myArray("/u/nlopez/path/is/long/file.txt")


//-- array cerated by split  on a str
def myArray(String text ){
        a= text.split("/")
        println a.length
        //println a.size
        println a[1]
