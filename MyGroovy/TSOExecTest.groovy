I wrote this groovy script for a customer to do some pre-processing of a cobol pgm using Rexx sample that I also wrote. If you need a walk thru let me know.  They can adapt that to run their Rexx.
...
TSOExec exec = new TSOExec()
	...
	exec.confDir('/u/nlopez/dbb-110/conf')					// points to the runIspf.sh interface 
...
/* Sample rexx code to be copied to a pds on MVS and used above
*  To use the rexx below, enclose above slash asterisk and unconments the code below 
*   
